    ...
    return {
        init: function () {
            ...
            a(),
                ...
                ((e = window.outerHeight) > 0 ? e : screen.height) &&
                ...
                $('a[data-action="expand"]').on("click", function (e) {
                    e.preventDefault(),
                        $(this)
                            ...
                            .toggleClass(
                                "icon-size-actual icon-size-fullscreen"
                            ),
                ...
                (function () {
                    ...
                    $(window).scroll(function () {
                        "horizontal" === $("body").attr("data-layout") &&
                            "static" ===
                                $("body").attr("data-header-position") &&
                            "fixed" ===
                                $("body").attr("data-sidebar-position") &&
                ...
                jQuery(".dz-chat-user-box .dz-chat-user").on(
                    "click",
                    function () {
                        jQuery(".dz-chat-user-box").addClass("d-none"),
                            jQuery(".dz-chat-history-box").removeClass(
                                "d-none"
                            );
                    }
                ),
...
$(document).ready(function (event) {
    ...
    $("select.form-select[multiple] option").on("mousedown", function (event) {
        event.preventDefault();
        $(this).prop("selected", !$(this).prop("selected"));
        if ($(this).prop("selected")) {
            $(this).addClass("selected-options");
        } else {
            $(this).removeClass("selected-options");
        }

        if ($(this).val() == 0) {
            $(this).siblings("option").prop("selected", false);
            $(this).siblings("option").removeClass("selected-options");
        } else {
            $(this).siblings("option:first-of-type").prop("selected", false);
            $(this)
                .siblings("option:first-of-type")
                .removeClass("selected-options");
        }
    });

    // ==================== checkList control ==================

    $(document).on("change",".checkList-item .checkList-item-group input[type=checkbox]",
    ...
    $(document).on("change",".checkList-item .checkList-item-single input[type=checkbox]",
