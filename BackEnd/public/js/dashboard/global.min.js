...
!(function (t, e) {
            ...
            return (
                (t.toggle = function () {
                    ...
                    this._element.setAttribute(
                        "aria-pressed", !this._element.classList.contains(w)
                    ),
    ...
    function jt(t) {
        ...
        for (
            var e = Ht(10) ? document.body : null, n = t.offsetParent || null; n === e && t.nextElementSibling;
        )
    ...
    p(window).on(hi.LOAD_DATA_API, function () {
        for (
            var t = [].slice.call(document.querySelectorAll(di)), e = t.length; e--;
        ) {
            var n = p(t[e]);
                ...
                ae.disableMutationObserver || _.ready("[data-aos]", se),
                    de(ae.disable) || re() ?
                        ...
                        (document
                            ...
                            document
                                .querySelector("body")
                                .setAttribute("data-aos-delay", ae.delay), -1 === ["DOMContentLoaded", "load"].indexOf(ae.startEvent) ?
                        ...
                        "DOMContentLoaded" === ae.startEvent && ["complete", "interactive"].indexOf(document.readyState) > -1 &&
                        ce(!0),
