...
$(document).ready(function () {
  $(".plan-phases .cards .stack").each((index, item) => {
    let length = $(item).find(".card:not(.shadow)").length;
    let focusFlag = true;
    ...
    $(item).hover(
      function () {
        let lenCard = $(this).find(".card:not(.shadow)").length;
        $(this)
          .find(".card")
          .each((index, item) => {
            $(item).css(
              "transform",
              `translateZ(calc(var(--cardZInc)*${lenCard - index}))`
            );
          });
      },
      function () {
        ...
        if (focusFlag) {
          $(this)
            .find(".card")
            .each((index, item) => {
              $(item).css("transform", `translateZ(${lenCard - index}px)`);
            });
        }
      }
    );
    ...
    $(item)
      .find(".card:not(.shadow)")
      .each((index, item) => {
        $(item)
          .css("transform", `translateZ(${length - index}px)`)
          .css("z-index", `${length - index}`);

        $(item).hover(
          function () {
            $(this).css(
              "transform",
              `translateX(20px) translateZ(calc(var(--cardZInc)*${
                length - index
              }))`
            );
          },
          function () {
            $(this).css(
              "transform",
              `translateZ(calc(var(--cardZInc)*${length - index}))`
            );
          }
        );
      });
